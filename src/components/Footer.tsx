import { InstagramIcon, TelegramIcon, YouTubeIcon } from '../assets/Icon'
  ...
  <div className="max-w-full mx-auto px-3 lg:px-5">
    <div className="py-6 lg:py-[60px]">
      <div className="w-full flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 lg:gap-0">
        <ul className="w-full lg:w-auto flex flex-col gap-1 md:gap-[5px]">
          <li>
            <strong className="font-medium text-[12px] md:text-[16px] lg:text-[20px] text-[#3E3E3E] mb-[2px]">
        ...
        <ul className="w-full lg:w-auto flex flex-col gap-1 md:gap-2">
          <li>
            <strong className="font-medium text-[12px] md:text-[18px] lg:text-[24px] text-[#3E3E3E]">
              {translations.footer.socialMedia}
            </strong>
          </li>
          <li className="flex items-center gap-2 md:gap-3 mt-2">
            <Link to="https://www.instagram.com/marstoys01/">
              <InstagramIcon />
            </Link>
            <Link to="https://www.youtube.com/channel/UCeBGmOrSWLpHz3ROCwlh8qA">
              <YouTubeIcon />
            </Link>
            <Link to="https://t.me/sardorigrushki">
              <TelegramIcon />
            </Link>
          </li>
        </ul>
